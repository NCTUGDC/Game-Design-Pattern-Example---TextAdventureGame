...
{
    public class Section : PlotTriggerElement
    {
        [MessagePackMember(id: 2, Name = "SectionID")]
        public int SectionID { get; private set; }

        [MessagePackMember(id: 3, Name = "SectionName")]
        public string SectionName { get; private set; }

        [MessagePackMember(id: 4, Name = "paragraphs")]
        private List<Paragraph> paragraphs;

        [MessagePackMember(id: 5, Name = "currentParagraphIndex")]
